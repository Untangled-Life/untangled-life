...
const createStyles = (t: Theme) =>
  ...
  modeLabel: { ...t.type.heading, color: t.textPrimary },
  modeLabelActive: { color: t.accent },
  modeBlurb: { ...t.type.caption, color: t.textSecondary, marginTop: 2 },
  tick: { color: t.accent, ...t.type.heading },
  ...
  saveButtonText: { color: t.textOnBrand, ...t.type.label },
  offButton: {
    backgroundColor: t.bg,
    borderRadius: t.radius.pill,
    paddingHorizontal: 18,
  ...
  offButtonText: { color: t.textSecondary, ...t.type.label },
  shiftRow: {
    flexDirection: "row",
