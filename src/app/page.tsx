  ...
  return (
    <>
      ...
      <main className="flex-1">
        <section className="bg-hero-bg px-6 pb-16 pt-16 text-hero-fg sm:pt-24">
          ...
          <div className="mx-auto flex max-w-5xl flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
            ...
            <p className="mt-4 text-[15px] leading-7 text-hero-fg2">
            ...
            <p className="mt-2 text-[15px] leading-7 text-hero-fg2">
      ...
      <footer className="px-6 py-14 text-center">
        ...
        <div className="mx-auto max-w-xl">
          ...
          <p className="mt-6 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 text-[13px]">
            ...
            <a href="/terms" className="text-text-muted underline underline-offset-2 hover:text-text-secondary">
              Terms of service
            </a>
          </p>
        </div>
